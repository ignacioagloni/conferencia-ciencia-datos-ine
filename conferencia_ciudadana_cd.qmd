...
[- No ha sido fácil llegar a donde estamos (tensión entre lo **urgente** y lo **estrétegico**)]{.medium-par .fragment}
...
[- Con el avance tecnológico en *hardware* y el boom de la inteligencia artificial se ha abierto un importante campo interdisciplinario entre los equipos de negocio y de tecnología]{.medium-par .fragment}
